...
log(`ultra-review: ${dimsRun.length} lenses, ${raw} candidate findings, ${confirmed.length} confirmed after ${VOTES}-vote adversarial verification`)
...
```
🛰  ultra-review swarm launched — run ID: wf_ab12cd34
...
If any issue was encountered, **edit this skill file** (`~/.claude/skills/ultra-review/SKILL.md`) with a surgical fix so the next run is better. Briefly tell the user what you changed and why.
