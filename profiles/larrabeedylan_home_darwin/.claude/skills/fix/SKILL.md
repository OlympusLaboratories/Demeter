...
2. **Invoke the `feedback` skill** using the `Skill` tool, passing the MR URL as the argument.
3. After the `feedback` skill completes, skip Steps 4 and 5 (plan and implement) — the feedback skill handles everything.
