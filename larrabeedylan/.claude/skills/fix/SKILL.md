...
2. **Invoke the `address-comments` skill** using the `Skill` tool, passing the MR URL as the argument.
3. After the `address-comments` skill completes, skip Steps 4 and 5 (plan and implement) — the address-comments skill handles everything.
...
- Did the commit-message and mr-description skills produce accurate output on the first try, or did the user need to correct them?
